...
Button::Button()
{
    ...
    buttonText="Wrong Constructor used";
}
...
Button::Button(ButtonSpriteTypes spriteIDIn, Vector2 postion, string buttonTextIn, Color textColorIn){
    spriteID = spriteIDIn; //Save Sprite ID
    ...
    buttonText=buttonTextIn; //Save the button text
...
void Button::draw()
{
    ...
    if(spriteID==ButtonSpriteTypes::UIPROMPT) DrawText(buttonText.c_str(), buttonArea.x+80, buttonArea.y+175, 20, textColor);
}
